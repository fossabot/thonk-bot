...
module.exports = {
    ...
    execute(message, args) {
        const itemID = args[0];
        if (!itemID) {
            const shopList = new discord.RichEmbed() //This following here is hard-coded, you must set it by your own. I'll try make a configurable items list soon.
